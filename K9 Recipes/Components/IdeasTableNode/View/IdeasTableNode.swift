...
class IdeasTableNode: TableNodeBase, ASTableDelegate, ASTableDataSource, UITableViewDelegate {
    
    var data: [IdeasTableNodeItem]?
    var onTap: (() -> Void)?
    ...
    convenience init(with items: [IdeasTableNodeItem]?) {
        self.init()
        self.data = items
    }
    ...
    func tableNode(_ tableNode: ASTableNode, nodeBlockForRowAt indexPath: IndexPath) -> ASCellNodeBlock {
        ...
        return { IdeasTableNodeCell(item: itemModel) }
    }
